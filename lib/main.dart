...
class _CalendarScreenState extends State<CalendarScreen>
  ...
  void _changeMonth(bool isNext) {
    if (isNext && _focusedDay.isAfter(DateTime(DateTime.now().year, DateTime.now().month))) {
      return;
    }
    setState(() {
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            IconButton(
              icon: Icon(Icons.chevron_right, color: _focusedDay.month == DateTime.now().month ? Colors.grey : Colors.black),
              onPressed: _focusedDay.month == DateTime.now().month ? null : () => _changeMonth(true),
            ),
          ],
        ),
        centerTitle: true,
